'use client';
import { Case, caseDataDummyList as data } from '@/lib/warrantyDB';
...
import AddJobBtn from '../jobs/AddJobBtn';

type WarrantyCasesListProps = {
  cases: Case[];
};
...
export default function WarrantyCasesList() {
